...
import { getAllMicDrop } from "../../../api/micdrop.api";
import { useAdminList } from "../../../hooks/useAdminList";
import { exportToExcel } from "../../../utils/excelExport";
import { Download, Search, ChevronLeft, ChevronRight } from "lucide-react";

export default function MicDropList() {
    const BACKEND_URL = import.meta.env.VITE_BACKEND_URL;
    const [data, setData] = useState([]);

    useEffect(() => {
        getAllMicDrop().then((res) => {
    ...
    return (
        <div className="p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <h1 className="text-2xl font-bold">Mic Drop Submissions</h1>
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <button
                        onClick={() => exportToExcel(data, "MicDrop_Submissions")}
                ...
                <table className="min-w-full bg-white text-sm">
                    <thead className="bg-gray-100 text-gray-700 uppercase">
                        <tr>
                            ...
                            <th className="px-3 py-3 text-left">Artist Name</th>
