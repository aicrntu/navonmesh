...
import { getAllBinaryBattle } from "../../../api/binarrybattle.api";
  ...
  return (
    <div className="p-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <h1 className="text-2xl font-bold">Binary Battle Submissions</h1>
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <button
            onClick={() => exportToExcel(data, "BinaryBattle_Submissions")}
