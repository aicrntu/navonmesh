...
export default function AdMadList() {
  ...
  useEffect(() => {
    getAllAdmad().then((res) => setData(res.data.data));
  }, []);
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">AdMad Submissions</h1>
        ...
        <table className="min-w-full bg-white text-sm">
          <thead className="bg-gray-100 text-gray-700 uppercase">
            <tr>
              ...
              <th className="px-3 py-3 text-left">Number Of Team Member</th>
