...
import { getAllTaleTellers } from "../../../api/taletellers.api";
import { useAdminList } from "../../../hooks/useAdminList";
import { exportToExcel } from "../../../utils/excelExport";
import { Download, Search, ChevronLeft, ChevronRight } from "lucide-react";

export default function TaleTellersList() {
    const BACKEND_URL = import.meta.env.VITE_BACKEND_URL;
    const [data, setData] = useState([]);

    useEffect(() => {
        getAllTaleTellers().then((res) => {
    ...
    return (
        <div className="p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <h1 className="text-2xl font-bold">Tale Tellers Submissions</h1>
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <button
                        onClick={() => exportToExcel(data, "TaleTellers_Submissions")}
