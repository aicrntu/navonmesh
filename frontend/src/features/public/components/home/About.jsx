                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <p className="text-sm text-gray-600 leading-relaxed text-justify font-medium">
                                    Navonmesh is Central India's Biggest Carnival: Celebrating Innovation and Creativity, presented by Scope Global Skills University (SGSU) and powered by AIC-RNTU. It's more than just an event—it's where ideas come to life, creativity flourishes, and the entrepreneurial spirit thrives. This flagship initiative offers a shared space for students, budding entrepreneurs, and researchers to walk alongside vocalists, movement artists, and industry leaders on one platform to learn, compete, and grow together.
                                </p>
                                <p className="text-sm text-gray-600 leading-relaxed text-justify font-medium">
