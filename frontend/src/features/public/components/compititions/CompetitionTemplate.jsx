...
import { ArrowLeft, ExternalLink, Calendar, MapPin, Trophy, Users, Star, Layout, Laptop, Bot, Megaphone, Hammer, Rocket, ArrowRight, CheckCircle } from 'lucide-react';
            ...
            */}
            ...
            {data.eligibility && (
                <section id="eligibility" className="py-24 bg-blue-50/50">
                    <div className="max-w-7xl mx-auto px-8 lg:px-20">
                        <h2 className="text-4xl font-black text-gray-900 tracking-tighter uppercase mb-16 text-center">Who Can <span className="text-primary italic">Apply</span>?</h2>
