...
const SoloSpotlightForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await soloSpotlightForm(payload);
            alert("Solo Spotlight registration successful 🎉");
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-20">
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                ...
                <div className="bg-[#008fad] p-8 text-center text-white">
                    ...
                    <a
                        href="/compitition/rule-book/RULE BOOK FOR SOLO DANCE COMPETITION NAVONMESH- 2026 (1).pdf"
                        target="_blank"
                ...
                <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10">
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    name="socialLink"
                                    placeholder="Social Media Link (Instagram/LinkedIn)"
                                    required
                                    onChange={handleChange}
                                    className={inputClass}
                                />
                    ...
                    <section>
                        <div className="flex items-center gap-2 mb-6 border-b pb-2">
                            <Share2 className="w-5 h-5 text-[#008fad]" />
                            <h3 className="text-lg font-bold text-gray-800">
                                Survey
                            </h3>
                        </div>
                    ...
                    >
                        {loading ? "Submitting..." : "Submit Talent Entry"}
                    </button >
...
export default SoloSpotlightForm;
