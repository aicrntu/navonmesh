                ...
                <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-10">
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div className="bg-pink-50 p-6 rounded-2xl border border-pink-100 flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="bg-gray-50 p-6 rounded-2xl border-2 border-dashed border-gray-200 hover:border-[#e91e63] transition-colors">
                                <label className={labelClass}>Upload Payment Screenshot *</label>
                                <div className="flex items-center gap-4">
                                    <Camera className="text-[#e91e63] w-8 h-8 opacity-60" />
                                    <input
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#e91e63] file:text-white hover:opacity-90 transition-all cursor-pointer"
                                    />
                                </div>
                            </div>
                        </div>
